...
exports.run = (client, message) => {
	let csgopng = "https://i.hizliresim.com/AZ09Y0.jpg"
    var kasadancikanlar = [
	...
	.setAuthor('Counter Strike: Global Offensive', csgopng)
	.setDescription(`${kasadancikanlar}`)
  .addField(`Kasayı Açan:`, `${message.author.username}`)
  .addField('GUZENMAN Kasası:', 'Fiyatı: 80$')
	.setFooter(`⚠️ Kasadan çıkan bütün ürünler sizde kalmaz sadece eğlence için yapılmış bir komutdur`)
	.setColor("RANDOM")
